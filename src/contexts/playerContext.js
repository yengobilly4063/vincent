...
import {  getActivePlayerInfoFromLocalStorage, getPlayersInfoFromLocalStorage, storeActivePlayerInfoToLocalStorage, storePlayersInfoToLocalStorage } from "../utils/player-util";
...
const PlayerContextProvider = ({children}) => {
    const [currentPlayer, setCurrentPlayer] = useState(getActivePlayerInfoFromLocalStorage())
    const [players, setPlayers] = useState(getPlayersInfoFromLocalStorage() || initialPlayerContextInfo.players);
    ...
    return <PlayerContext.Provider value={{ handleSetPlayers, activePlayer, switchActivePlayer}}>
        {children}
